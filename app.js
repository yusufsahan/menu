...
btnAll.type = "button";
btnAll.classList.add("btn-item", "btn-success");
...
btnKorea.classList.add("btn-item", "btn-success");
...
btnJapon.classList.add("btn-item", "btn-success");
...
btnChina.classList.add("btn-item", "btn-success");
        ...
        <div class="col-md-7">
          <div class="card-body">
            ...
            <div class="d-grid gap-2">
              <button class="btn btn-primary" type="button"> ${item.price} </button>
            </div>
          </div>
        </div>
      </div>
